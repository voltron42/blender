describe("Mockabilly", function(){
	...
	it("mockFunction will record calls", function() {
		var mockFn = Mockabilly.mockFunction().build()
	...
	it("mockFunction will record arguments for each call", function() {
		var mockFn = Mockabilly.mockFunction().build()
		var call;
		mockFn("a");
		expect(mockFn.meter.getCallCount()).to.equal(1);
	...
	it("mockFunction can recognize parameters",function() {
		var mockFn = Mockabilly.mockFunction()
			.addParam('firstName')
			.addParam('lastName')
			.build()
	...
	it("mockFunction can return another mockFunction as a callback",function() {
	...
	it("mockFunction can return the result of a callback",function() {
		var obj = {
			field:"Hi there"
		}
	...
	it("mockFunction can return the result of a callback involving the scope of its owner",function() {
	...
	it("instance can mock an object with multiple functions",function() {
	...
	it("instance can add mock functions to an existing object",function() {
		var joe = {
	...
	it("instance mock functions can return the result of a callback involving the scope of its owner",function() {
		var resultFn = function() {
			return this.field;
		}
		var obj = {
	...
	it("instance mock functions return result callback has access to the original function",function() {
	...
	it("instance can override functions on an existing object with mocks",function() {
		var obj = {
			field:"Hi there",
			fn:function() {
				return this.field;
	...
	it("mockConstructor creates mock instances",function() {
		var Person = function(){};
	...
	it("mockConstructor instances match instanceof a chosen prototype (class)",function() {
		var Person = function(){};
		var personMocker = new Mockabilly();
		var MockPerson = Mockabilly.mockConstructor(new Person(), personMocker).build();
	...
	it("mockConstructor's underlying mockabilly can have its nature changed so that different instances can behave differently", function() {
		var Person = function(){};
		var personMocker = new Mockabilly();
		var MockPerson = Mockabilly.mockConstructor(new Person(), personMocker).build();
	...
	it("mockTimeout replaces global functions 'setTimeout' and 'clearTimeout' with mock versions", function() {
		var local = {
			set:setTimeout,
			clear:clearTimeout
		}
	...
	it("mockTimeout will mock the Timeout's perception of the passage of time", function() {
		var clock = Mockabilly.mockTimeout();
		clock.useMock();
		var obj = {name:"Steve"}
		setTimeout(function() {
	...
	it("mockTimeout can handle multiple calls of setTimeout", function() {
		var clock = Mockabilly.mockTimeout();
		clock.useMock();
		var obj = {
			string:""
	...
	it("mockTimeout can handle recursive timeouts", function() {
		var clock = Mockabilly.mockTimeout();
		clock.useMock();
		var obj = {
			string:"A"
	...
	it("mockTimeout can handle clearing recursive timeouts", function() {
		var clock = Mockabilly.mockTimeout();
		clock.useMock();
		var obj = {
			string:"A",
